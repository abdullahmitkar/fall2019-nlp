...
class ProbingClassifier(models.Model):
    def __init__(self,
        ...
        # TODO(students): start
        # ...
        self.classifier = layers.Dense(units=classes_num)
        # TODO(students): end
    ...
    def call(self, inputs: tf.Tensor, training: bool =False) -> tf.Tensor:
        ...
        model = self._pretrained_model(inputs, training)
        layer_rep = model["layer_representations"]
        logits = self.classifier(layer_rep[:,self._layer_num-1,:]);
        # ...
        # TODO(students): end
