...
def train(model: models.Model,
    ...
    for epoch in range(num_epochs):
        ...
        for index, (batch_inputs, batch_labels) in enumerate(generator_tqdm):
            ...
            # print("Total Training loss",total_training_loss) # Comment out
...
if __name__ == '__main__':
    ...
    if args.use_cached_data:
        ...
        # print("Loading Serialised file")
        # file = open("train_instances.pkl",'rb')
        # train_instances=pickle.load( file)
        # file.close();
        # print("Serialisation loading done")
